...
def write_to_excel(poilist, cityname, classfield):
    ...
    for i in range(len(poilist)):
        ...
        location_lon = float(poilist[i]['location'].split(',')[0])
        location_lat = float(poilist[i]['location'].split(',')[1])
        ...
        newMap.createPoint(newLayer, location_lon, location_lat, fieldValues)
        newMap.createPolygon(newLayer,[bounlist] , fieldValues)
